...
import lesson16.Lesson16Activity;
...
public class MainScreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHw16 = findViewById(R.id.btn_hw16);
        ...
        btnHw16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(MainScreenActivity.this, Lesson16Activity.class);
                startActivity(intent);
            }
        });
    }
